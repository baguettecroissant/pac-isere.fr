...
const SITE_DOMAIN = 'pac-isere.fr';
const SITE_NICHE = 'pac';
const DEPT_CODE = '38';
...
// ── Category name mapping for common PAC categories ──
const CAT_NAMES = {
  ...
  171: 'Dépannage PAC / climatisation',
  19: 'Climatisation',
};
...
export async function onRequestPost(context) {
  try {
    ...
    const workDescription = `Projet: Travaux PAC en ${ville} (${cp}). Chauffage actuel: ${chauffageActuel || 'Non renseigné'}. Délai: ${
    ...
    // ══════════════════════════════════════════════════════════════
    // ÉTAPE 1 : INSERT dans Supabase (on sécurise les PII d'abord)
    // ══════════════════════════════════════════════════════════════
    let supabaseId = null;
    try {
      ...
      // Continue — don't block the lead from going to VUD
    }

    // ══════════════════════════════════════════════════════════════
    // ÉTAPE 2 : PING ViteUnDevis (vérifier acheteur)
    // ══════════════════════════════════════════════════════════════
